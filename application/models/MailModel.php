        ...
        $html = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                    ...
                    <html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                        ...
                        <body style="margin: 0; padding: 0;">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border: solid 1px #e9f4d5; width: 60%">
                                <tbody>
                                <tr>
                                    <td align="center" bgcolor="#fff" style="padding: 20px 0 20px 0; border: solid 1px #fff;">
                                        <img src="'.base_url().'assets/images/logo2.png" alt="HomeBuds" width="100" style="display: block;">
                                    </td>
                                </tr>
                                '.$content.'
                                    ...
                                    <p style="text-align: center; text-decoration: none; font-size: 10px; font-family: Arial, sans-serif;">
                                            <a href="#" style="text-decoration: none; color: #a9adb0">
                                                    &copy; 2016 HomeBuds. <span>All rights reserved</span>
                                            </a>
                                    </p>
