...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<? echo base_url(); ?>assets/lib/animate.css">
        ...
        <link rel="stylesheet" type="text/css" href="<? echo base_url(); ?>assets/theme-admin/css/login.css">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-offset-4 col-md-4 col-sm-offset-3 col-sm-6 col-xs-offset-1 col-xs-10 content-outer">
                    <div class="logo">
                        <img src="<? echo base_url(); ?>assets/images/homebuds-logo2.fw.png" alt="HomeBuds">
                        <!--<h4 style="color: #f8f8f8">HomeBuds</h4>-->
                    </div>
